...
//        builder.setSpout("SubSpout", new SubscriptionSpout(dataDistributionType), numExecutorInASpout);
        ...
        for (; boltId <parallelismDegree;boltId++){
            builder.setBolt("TamaMPMBolt"+String.valueOf(boltId), new TamaMPMatchBolt(groupID,boltId, 1, redundancy, utils.getNumVisualSubSet(), utils.getVSSIDtoExecutorID()), numExecutorInAMatchBolt).directGrouping("SubscriptionSpout_emitDirect").allGrouping("EventSpout");
        }
